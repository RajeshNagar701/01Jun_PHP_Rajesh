                            ...
                            <div class="panel-body">
                                <form action="{{url('/alogin_auth')}}" method="post" role="form">
                                    ...
                                    <h5>Enter Admin Details to Login</h5>
                                       <br />
										<div class="form-group input-group">
                                            ...
                                            <input type="text" value="{{old('username')}}" name="username" class="form-control" placeholder="Your Username " />
                                    ...
                                    <div class="form-group">
                                     ...
                                     <input type="submit" name="submit" class="btn btn-primary ">Login Now</a>
