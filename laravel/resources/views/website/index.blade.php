      ...
      <div class="slider_container">
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img src="{{url('website/images/slider-img.png')}}" alt="" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="carousel_btn-box">
            ...
            <img src="{{url('website/images/line.png')}}" alt="" />
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="{{url('website/images/saving-img.png')}}" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="img_container">
              <div class="img-box">
                <img src="{{url('website/images/gifts.png')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-7">
